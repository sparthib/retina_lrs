...
#SBATCH -o logs/new_fa/isoquant.%a.txt
#SBATCH -e logs/new_fa/isoquant.%a.txt
#SBATCH --array=1-4

#rerunning isoquant with new reference fasta
...
OUTPUT_FOLDER=/dcs04/hicks/data/sparthib/casey/IsoQuant_output_new_fa/${sample}
# rm -r $OUTPUT_FOLDER
