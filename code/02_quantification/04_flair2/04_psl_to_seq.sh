...
#SBATCH --mem=100G
#SBATCH -c 20
#SBATCH --job-name=flair_psl_to_seq
#SBATCH --mail-user=sparthi1@jhu.edu
#SBATCH --mail-type=ALL
#SBATCH -o logs/flair_psl_to_seq.%a.txt
#SBATCH -e logs/flair_psl_to_seq.%a.txt
#SBATCH --array=1-15
...
out_fa=/dcs04/hicks/data/sparthib/retina_lrs/06_quantification/flair2/assign_variants/${sample}.fa
...
psl_to_sequence $out_bed $REFERENCE_FASTA $out_fa -v $out_vcf
