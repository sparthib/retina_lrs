...
DTE_table <- read_tsv("/users/sparthib/retina_lrs/processed_data/dtu/Isoquant/ROs/DTE_table.tsv")


DTE_table |> filter(FDR < 0.05) 
DTE_table$condition_1
DTE_table$condition_2
