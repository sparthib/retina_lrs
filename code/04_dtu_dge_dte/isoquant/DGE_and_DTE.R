...
#keep only rows that have atleast 1 TPM on average for each condition  based on IsoformSwitchAnalyzer filter
sample_to_group <- c("EP1-BRN3B-RO" = "RO_D200", 
                     "EP1-WT_ROs_D45" = "RO_D45", 
                     "EP1-WT_hRO_2" = "RO_D100", 
                     "H9-BRN3B-RO" = "RO_D200", 
                     "H9-BRN3B_hRO_2" = "RO_D100", 
                     "H9-CRX_ROs_D45" = "RO_D45", 
                     "H9-CRX_hRO_2" = "RO_D100")

#atleast 3 counts in atleast 2 samples 
keep <- filterByExpr(y, min.count=3)
filtered_RO_counts <- RO_counts[keep, ]
...
#only keep rows that have atleast 1 count in atleast 2 samples
