...
files <- list.files(path = file.path(data_dir,"09_ASE/H9_DNA_Seq_data/H9_EP1_bambu"),
...
dir.create(file.path(code_dir, "processed_data/ASE/bambu_counts_matrices/"),
...
readr::write_tsv(as.data.frame(filtered_cpm_matrix) |> 
                       ...
                       file = file.path(code_dir,
                                        "processed_data/ASE/bambu_counts_matrices/bambu_ptc_gene_cpm.tsv"))
...
counts <- readr::read_tsv(file.path(code_dir, 
                                    "processed_data/ASE/bambu_counts_matrices/bambu_ptc_gene_counts.tsv"))

cpm <- readr::read_tsv(file.path(code_dir,
                                 "processed_data/ASE/bambu_counts_matrices/bambu_ptc_gene_cpm.tsv"))