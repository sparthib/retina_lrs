...
ird_genes <- readr::read_tsv(file = "/users/sparthib/retina_lrs/processed_data/dtu/retnet_disease_genes.tsv", 
                             col_names = TRUE)
...
readr::write_tsv(ird_genes,
                 "/users/sparthib/retina_lrs/processed_data/dtu/retnet_disease_genes.tsv")
...
go_plot_dir <- here("processed_data", "ASE", "bambu_counts_matrices","GO_plots")
