...
myDesign  <- data.frame(sampleID = c("EP1.BRN3B.RO" ,  "EP1.WT_ROs_D45", 
                                      "H9.BRN3B.RO",  "H9.CRX_ROs_D45") ,
                        condition = c("RO_D200",  "RO_D45",  "RO_D200", "RO_D45"),
...
if(!file.exists("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/DTE_table.tsv")){
  ...
  contr <- makeContrasts(RO_D200 - RO_D45, levels=design)
  ...
  write_tsv(tt$table, file = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/DTE_table.tsv")
  
} else {
  DTE_table <- readr::read_tsv("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/DTE_table.tsv")
}

if(!file.exists("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/DGE_table.tsv")){
  ...
  group <- factor(c("RO_D200",  "RO_D45",  "RO_D200", "RO_D45"))
  y_dge <- DGEList(counts=counts, group=group, genes=counts$gene_id,
                   samples = c("EP1.BRN3B.RO" ,  "EP1.WT_ROs_D45", 
                               "H9.BRN3B.RO",  "H9.CRX_ROs_D45"))
  ...
  write_tsv(tt_dge$table, file = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/DGE_table.tsv")
} else {
  DGE_table <- readr::read_tsv("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/DGE_table.tsv")
}


###add gene names 
dtu_rdata_path  = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/DexSeqDTUDGESwitchList.rds"
...
if(!file.exists(dtu_rdata_path)){
  ...
  SwitchList_part1 <- extractSequence(
    ...
    pathToOutput       = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/",
...
if(!file.exists("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/DGE_DTU_DTE.tsv")){
...
SwitchList_part2 <- isoformSwitchAnalysisPart2(
  ...
  pathToSignalPresultFile   = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/prediction_results.txt",
  outputPlots               = TRUE,
  pathToOutput              = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/part_2",
...
pdf("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D200_vs_RO_D45/CPC2_stacked_barplot.pdf")
