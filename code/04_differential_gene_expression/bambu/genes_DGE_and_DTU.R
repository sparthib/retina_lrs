...
dge_dir <- "/users/sparthib/retina_lrs/processed_data/dge/edgeR/bambu/"
...
dtu_dir <- "/users/sparthib/retina_lrs/processed_data/dtu/IsoformSwitchAnalyzeR/bambu/"
...
write_tsv(FT_vs_RGC_merged, "/users/sparthib/retina_lrs/processed_data/dge_dtu/bambu/FT_vs_RGC_dtu_dge.tsv")
write_tsv(D100_vs_D45_merged,"/users/sparthib/retina_lrs/processed_data/dge_dtu/bambu/D100_vs_D45_dtu_dge.tsv")
write_tsv(D200_vs_D100_merged, "/users/sparthib/retina_lrs/processed_data/dge_dtu/bambu/D200_vs_D45_dtu_dge.tsv")
write_tsv(D200_vs_D45_merged, "/users/sparthib/retina_lrs/processed_data/dge_dtu/bambu/D200_vs_D100_dtu_dge.tsv")
