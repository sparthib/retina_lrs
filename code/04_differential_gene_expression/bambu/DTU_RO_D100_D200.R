...
cpm <- cpm[, -2]
cpm <- cpm[, c(1, 2, 3, 5,6,7)]
head(cpm)

myDesign  <- data.frame(sampleID = c("EP1.BRN3B.RO", "EP1.WT_hRO_2", "H9.BRN3B_hRO_2",
                                     "H9.BRN3B.RO", "H9.CRX_hRO_2" ) ,
                        condition = c("RO_D200",  "RO_D100",  "RO_D100", 
                                      "RO_D200","RO_D100"),
                        stringsAsFactors = FALSE)

list.files("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/")

rdata_path = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/SwitchList.rds"
...
if(!file.exists("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DTE_table.tsv")){
  ...
  contr <- makeContrasts(RO_D100 - RO_D200, levels=design)
  ...
  write_tsv(tt$table, file = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DTE_table.tsv")
  
} else {
  DTE_table <- readr::read_tsv("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DTE_table.tsv")
}

if(!file.exists("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DGE_table.tsv")){
  ...
  group <- factor(c("RO_D200",  "RO_D100",  "RO_D100", 
                    "RO_D200","RO_D100"))
  y_dge <- DGEList(counts=counts, group=group, genes=counts$gene_id,
                   samples = c("EP1.BRN3B.RO", "EP1.WT_hRO_2", "H9.BRN3B_hRO_2",
                               "H9.BRN3B.RO", "H9.CRX_hRO_2"))
  ...
  write_tsv(tt_dge$table, file = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DGE_table.tsv")
} else {
  DGE_table <- readr::read_tsv("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DGE_table.tsv")
}


###add gene names 
dtu_rdata_path  = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DexSeqDTUDGESwitchList.rds"
...
if(!file.exists(dtu_rdata_path)){
  ...
  SwitchList_part1 <- extractSequence(
    ...
    pathToOutput       = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/",
  ...
  SwitchList_part1 <- readRDS("./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DexSeqDTUDGESwitchList.rds")
}
...
if(!file.exists("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DGE_DTU_DTE.tsv")){
  ...
  write_tsv( DGE_DTU_DTE, file = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DGE_DTU_DTE.tsv")
} else {
  DGE_DTU_DTE <- readr::read_tsv("./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DGE_DTU_DTE.tsv")
}
...
library(patchwork)
p <- dge_bar + dte_bar + plot_annotation(title = 'RO_D100 vs RO_D200')
ggsave(path = "./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/",
       device = "pdf", plot = p, filename = "DGE_DTU_DTE_barplot.pdf")

# save venn diagram as pdf 
pdf("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/DGE_DTU_DTE_venn.pdf")
...
pdf("./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/Splicing_Summary.pdf")
...
dev.off()
pdf("./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/Splicing_Enrichment.pdf")
...
SwitchList_part2 <- isoformSwitchAnalysisPart2(
  ...
  pathToCPC2resultFile      = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/CPC2_output.txt",
  pathToPFAMresultFile      = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/pfam_results.txt",
  pathToSignalPresultFile   = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/prediction_results.txt",
  outputPlots               = TRUE,
  pathToOutput              = "/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/part_2",
...
# library("ggthemes")
pdf("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/Switchplot_with_consequence.pdf")
...
pdf("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D200/CPC2_stacked_barplot.pdf")
