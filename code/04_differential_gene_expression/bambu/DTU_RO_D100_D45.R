...
if(!file.exists("/users/sparthib/retina_lrs/processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D45/DGE_DTU_DTE.tsv")){
  ...
  DGE_DTU_DTE <- readr::read_tsv("./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D45/DGE_DTU_DTE.tsv")
}

#### VENN DIAGRAM ####
# 11170 genes after filtering
...
library(patchwork)
p <- dge_bar + dte_bar + plot_annotation(title = 'RO_D100 vs RO_D45')
ggsave(path = "./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D45/",
...
SwitchList_part2 <- readRDS("./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D45/SwitchList_part2.rds")


pdf("./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D45/Splicing_Summary.pdf")
...
dev.off()
pdf("./processed_data/dtu/DTU_gandall/bambu/RO_D100_vs_RO_D45/Splicing_Enrichment.pdf")
