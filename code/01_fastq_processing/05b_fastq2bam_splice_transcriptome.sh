...
echo "$sample"
SAM_FOLDER=/dcs04/hicks/data/sparthib/retina_lrs/04_sams/transcriptome/GENCODE_splice
BAM_FOLDER=/dcs04/hicks/data/sparthib/retina_lrs/05_bams/transcriptome/GENCODE_splice
...
samtools view -h -bS -q 30 -F  ${SAM_FOLDER}/${sample}.sam -o ${BAM_FOLDER}/${sample}.bam
