...
gc_wise_average <- transcript_info |> group_by(gc_content_bin) |> 
...
output_dir <- "/dcs04/hicks/data/sparthib/sg_nex_data/coverage/averages"
...
output_plot_dir <- "/dcs04/hicks/data/sparthib/sg_nex_data/coverage/plots"
