...
## --sample=SRR1091091 this tag comes right after --ignore-read-groups if VCF has multiple samples
whatshap phase -o $phased_vcf_dir/all_samples_phased.vcf --ignore-read-groups \ 
--reference=$ref_fa $vcf_dir/all_samples_variants.vcf.gz \
