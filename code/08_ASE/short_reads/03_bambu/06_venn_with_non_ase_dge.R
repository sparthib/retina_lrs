...
non_ASE_RO_dir <- here("processed_data", "dtu", "bambu", "ROs",
                       "protein_coding", "DGE")
non_ASE_FT_RGC_dir <- here("processed_data", "dtu", "bambu", "FT_vs_RGC",
                           "protein_coding") 
...
H1_dir <- here("processed_data", "ASE", 
               "bambu_counts_matrices", "DGE", "between_stage_in_H1_allele")
H2_dir <- here("processed_data", "ASE", 
