...
whatshap haplotag -o $vcf_dir/H9-hRGC_1_sorted_haplotagged.bam \
    --reference $ref_fa \
    $vcf_dir/SRR1091088.phased.vcf.gz \
    /dcs04/hicks/data/sparthib/retina_lrs/09_ASE/H9_DNA_Seq_data/vcf/H9-hRGC_1_rg.bam \
    --ignore-read-groups
>>>>>>> 4085335 (update code)
