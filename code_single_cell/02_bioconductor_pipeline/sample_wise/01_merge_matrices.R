...
load_matrix <- function(sample) {
  ...
  matrix_file <- file.path("/dcs04/hicks/data/sparthib/retina_single_cell_lrs/05_flames_output/", 
                           paste0(sample, "/transcript_count.csv.gz"))
  ...
  df <- read.csv(gzfile(matrix_file), row.names = 1, header = TRUE)
...
output_dir <- "/dcs04/hicks/data/sparthib/retina_single_cell_lrs/06_sce_rds_files/transcriptome/merged_matrices"
...
mat_10x_D100_EP1 <- merge_counts_matrices(mat_list[1:4], fill_value = 0, output_name = "mat_10x_D100_EP1")
dim(mat_10x_D100_EP1)

mat_10x_D200_EP1_1 <- merge_counts_matrices(mat_list[5:8], fill_value = 0, output_name = "mat_10x_D200_EP1_1")
mat_10x_D200_EP1_2 <- merge_counts_matrices(mat_list[9:12], fill_value = 0, output_name = "mat_10x_D200_EP1_2")
